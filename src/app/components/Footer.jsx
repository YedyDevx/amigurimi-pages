...
export default function Footer() {
  ...
  <Shadow />
  <motion.div
    className="w-full mx-auto flex flex-col px-20 justify-around items-center flex-wrap relative pt-5 bg-white bg-opacity-50 text-gray-800 font-lato shadow-2xl"
    initial={{ opacity: 10 }}
    animate={{ opacity: -10 }}
    ...
    <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 justify-between items-center max-w-[1500px]">
      ...
      exit={{ opacity: 0 }}
      transition={{ duration: 2 }}
      className="flex flex-col gap-3 items-center text-gray-800">
