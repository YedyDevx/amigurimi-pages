...
export default function MobileMenu() {
  return (
    ...
    className="lg:hidden flex flex-col items-center gap-4 font-lato text-lg text-[#1f6c76] font-bold bg-white shadow-md p-4 absolute w-full top-[70px] left-0 z-40">
